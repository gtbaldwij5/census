...
# print(data)
#
# df.to_csv(r'TX_Travis.csv')



df_2 = pd.read_csv(r'TX_Travis.csv')
...
df_3.to_csv(r'TX_Travis2.csv')

pd.read_csv(r'TX_Travis2.csv')
...
df_3.to_csv(r'TX_Travis_MedIncWeight.csv')